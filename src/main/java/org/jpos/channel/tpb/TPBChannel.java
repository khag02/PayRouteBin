 ...
 * [DATA ELEMENTS...]
 */
public class TPBChannel extends BaseChannel {
    /**
     * Public constructor
     */
     ...
     * @see ISOPackager
     */
    public TPBChannel(String host, int port, ISOPackager p, byte[] TPDU) {
        this.header = TPDU;
    }
     ...
     * @see ISOPackager
     */
    public TPBChannel(ISOPackager p, byte[] TPDU) throws IOException {
        this.header = TPDU;
    }
     ...
     * @see ISOPackager
     */
    public TPBChannel(ISOPackager p, byte[] TPDU, ServerSocket serverSocket)
            throws IOException {
        this.header = TPDU;
    }
