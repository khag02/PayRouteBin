...
public class VIBChannel extends BaseChannel {
     ...
     * @see ISOPackager
     */
    public VIBChannel(String host, int port, ISOPackager p, byte[] TPDU) {
        this.header = TPDU;
    }
     ...
     * @see ISOPackager
     */
    public VIBChannel(ISOPackager p, byte[] TPDU) throws IOException {
        this.header = TPDU;
    }
     ...
     * @see ISOPackager
     */
    public VIBChannel(ISOPackager p, byte[] TPDU, ServerSocket serverSocket)
            throws IOException {
        this.header = TPDU;
    }
