 ...
 * [DATA ELEMENTS...]
 */
public class VCBChannel extends BaseChannel {
    /**
     * Public constructor
     */
     ...
     * @see ISOPackager
     */
    public VCBChannel(String host, int port, ISOPackager p, byte[] TPDU) {
        this.header = TPDU;
    }
     ...
     * @see ISOPackager
     */
    public VCBChannel(ISOPackager p, byte[] TPDU) throws IOException {
        this.header = TPDU;
    }
     ...
     * @see ISOPackager
     */
    public VCBChannel(ISOPackager p, byte[] TPDU, ServerSocket serverSocket)
            throws IOException {
        this.header = TPDU;
    }
